...
def delivery_id(bot, update, user_data):
	...
	update.message.reply_text(
		'How many of this item(' + database.get_dish_name(deliveryId) + ') are you getting? (Please enter a numerical figure, additional comments can be filled in under remarks)')

...
def delivery_id(bot, update, user_data):
	...
	update.message.reply_text(
		'How many of this item are you getting? (Please enter a numerical figure, additional comments can be filled in under remarks)')
...
join_delivery_conv_handler = ConversationHandler(
	entry_points=[CommandHandler('joindeliveries', join_delivery, pass_user_data=True)],
	states={
